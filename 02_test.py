...
print("Calcul du nombre d’étiquettes"); input(pause89)
train_images.shape
...
print("Construire le modèle"); input(pause89)
...
print("Former le modèle"); input(pause89)
...
print("Utiliser le modèle entraîné"); input(pause89)
img = test_images[1]
print(img.shape)
