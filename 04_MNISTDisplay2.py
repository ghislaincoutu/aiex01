...
print("Chargement d’un jeu de données Fashion MNIST")
pause()
...
print("Calcul du nombre d’étiquettes")
pause()
train_images.shape
...
print("Affichage des 25 premières images")
pause()
...
print("Utiliser le modèle entraîné")
pause()
img = test_images[1]
print(img.shape)
